...
class ShowFlyingFleetPage extends AbstractAdminPage
{
	...
	function show()
	{
        ...
        if(!empty($id)){
            ...
            $GLOBALS['DATABASE']->query("UPDATE ".FLEETS." SET `fleet_busy` = '".$lock."' WHERE `fleet_id` = '".$id."' AND `fleet_universe` = '".Universe::current()."';");
        ...
        WHERE fleet_universe = ".Universe::current()."
        ...
        $this->display('page.flyingFleet.default.tpl');
	}
}
