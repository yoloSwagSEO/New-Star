...
class ShowArtifactPage extends AbstractGamePage
{
	...
	public function UpdateArtifact($Element)
	{
	...
	public function show()
	{
		...
		{
			if(in_array($updateID, $reslist['artifact'])) {
				$this->UpdateArtifact($updateID);
			}
		}
		...
		{
			foreach($reslist['artifact'] as $Element)
			{
		...
		$this->display('page.artifact.default.tpl');
	}
}
