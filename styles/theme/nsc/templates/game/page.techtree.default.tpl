            ...
            <div class="record_rows">
               ...
               <div class="required_blocks">
                  ...
                  <div class="required_block required_smal_text" style="top: 1px;">
                     <a href="#" onclick="return Dialog.info({$requireID})" class="tooltip2m" data-tooltip-content="<span style='color:{if $NeedLevel.own < $NeedLevel.count}red{else}lime{/if};'>{$LNG.tech.$requireID} ({$LNG.tt_lvl} {min($NeedLevel.count, $NeedLevel.own)}/{$NeedLevel.count})</span>">
